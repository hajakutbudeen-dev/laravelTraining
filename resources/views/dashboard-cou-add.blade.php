            ...
            <form action="{{ url('admin-course-add') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="name" name="name" class="form-control" id="courseName" placeholder="Ex: Diploma in Laravel" required>
                </div>
                ...
                <div class="form-group">
                  <label>Category</label>
                    <select class="form-control" style="width: 100%;" name="catogory" required>
                ...
                <div class="form-group">
                    ...
                    <select class="select2" multiple="multiple" data-placeholder="Select option" name="technologies[]" style="width: 100%;" required>
                      @foreach($technologies as $technology)
                        <option>{{$technology->technology_name}}</option>
                      @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                  <label>Instructor</label>
                    <select class="form-control" style="width: 100%;" name="instructor" required>
                      <option selected="selected" disabled>Select Option</option>
                ...
                <div class="form-group">
                  <label>Language</label>
                    <select class="select2" multiple="multiple" data-placeholder="Select option" style="width: 100%;" name="locale[]" required>
                      <option>Tamil</option>
                ...
                <div class="form-group">
                  ...
                  <input type="name" name="price" class="form-control" id="coursePrice" placeholder="Ex: 500 USD" required>
                </div>
                <div class="form-group">
