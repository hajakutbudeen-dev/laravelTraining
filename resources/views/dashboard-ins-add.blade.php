    ...
    <!-- /.content-header -->
     ...
     <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-6">
            <form action="{{ url('admin-instructor-add') }}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                <div class="form-group">
                  <label for="instructorName">Name</label>
                  <input type="name" name="name" class="form-control" id="instructorName" placeholder="Ex: Thomas" required>
                </div>
                <div class="form-group">
                  <label>Gender</label>
                ...
                <div class="form-group">
                  ...
                  <input type="name" name="email" class="form-control" id="instructorEmail" placeholder="Ex: info@email.com" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="name" name="designation" class="form-control" id="instructorDesignation" placeholder="Ex: Web Developer" required>
                </div>
                <div class="form-group">
